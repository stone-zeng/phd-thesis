  ...
  \item 对最终得到的不动点张量进行求迹操作即可得到配分函数 $Z$：
    \begin{equation}
      Z = \sum_{i,j} A^{(N)}_{ijij}
        = \vcenter{\hbox{\includegraphics[width=2.5cm]{images/temp/trg-double-trace.png}}}
    \end{equation}
\end{enumerate}
...
\begin{equation}
  \delta = \vcenter{\hbox{\includegraphics[width=6cm]{images/temp/trg-truncation-error.png}}}
\end{equation}
