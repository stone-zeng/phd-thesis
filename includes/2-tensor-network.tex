...
\begin{figure}[htb]
  ...
  \begin{tabular}{cc}
    \parbox{2em}{\subcaption{}} &
      $\vcenter{\hbox{\includegraphics[width=0.7\textwidth]{images/temp/dmrg-two-site.png}}}$ \\
    \parbox{2em}{\subcaption{}} &
      $\vcenter{\hbox{\includegraphics[width=0.7\textwidth]{images/temp/dmrg-two-site-svd.png}}}$
  \end{tabular}
