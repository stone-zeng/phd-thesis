...
临界格点模型是研究\emph{共形场论} (conformal field theory, CFT) 的有力工具。有许多格点模型能够揭示出重要的 CFT 数据，而其中最基本也是最重要的一类称为\emph{最小模型} (minimal models)。它们同时也是严格可解模型，而对应的拓扑以及范畴对称性可以通过融合范畴（见 \ref{sec:tensor-category-fusion-category} 节）添加进来\cite{vanhove2018mapping,aasen2020topological,huang2022numerical,vanhove2022critical}。
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.4\textwidth]{images/virasoro/operator.pdf}
